...
> Prüfung unterzogen (513 automatisierte Tests). Alle zehn im Auftrag
> vorgesehenen Oberflächenseiten sind gebaut (siehe `TODO.md`).
> **Noch nicht vollständig abnahmefähig** im strengen Sinn von
> Auftrag §15 — eine ehrliche, kriterienweise Bewertung mit dem
> verbleibenden offenen Punkt (kein Internetzugang in dieser
> Entwicklungsumgebung, daher keine Verifikation mit echten
> Marktdaten) steht in `ABNAHME.md`. Ausführliche Bedienungsanleitung:
> `BENUTZERHANDBUCH.md`. Details:
